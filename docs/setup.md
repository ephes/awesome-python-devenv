...
Set the Mac's computer name early so AirDrop, network sharing, terminal prompts, and SSH-visible hostnames use the intended machine name from the start.

Why: changing the machine name late is easy, but doing it early avoids stale defaults showing up in sharing, shell prompts, and other machine-to-machine workflows.

Details: [machine.md](machine.md#rename-the-machine-early)
...
## 7. Install chezmoi and apply dotfiles
...
## 8. Install packages and CLI tools
...
## 9. Switch the login shell to fish
